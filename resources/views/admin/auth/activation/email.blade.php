                        ...
                        <auth-form
                            ...
                            <form class="form-horizontal" role="form" method="POST"
                                ...
                                <div class="auth-header">
                                    ...
                                    <p class="auth-subtitle">{{ trans('zekini/livewire-crud-generator::admin.activation_form.note') }}</p>
                                </div>
                                <div class="auth-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <button type="submit" class="btn btn-primary btn-block btn-spinner"><i
                                                    class="fa"></i> {{ trans('zekini/livewire-crud-generator::admin.activation_form.button') }}
                                        </button>
                                    </div>
                                </div>
                            </form>
