<div x-data="{ open: {{ isset($open) && $open ? 'true' : 'false' }}, working: false }" x-cloak >
    ...
    <div x-show="open"
        ...
        <div x-show="open" x-transition:enter="ease-out duration-300"
            ...
            class="relative bg-gray-100 rounded-lg px-4 pt-5 pb-4 overflow-hidden shadow-xl transform transition-all sm:max-w-lg sm:w-full sm:p-6" style="z-index:1029;">
