    ...
    <div class="relative">
        <div class="flex items-center justify-between mb-1">
            <div class="flex items-center h-10">
                ...
                @endif
                @if(isset($importBtn) && $importBtn)
                <div class="flex flex-row">
                <label wire:click="$emit('import')" type="button" for="upload-btn"
                    class="flex items-center space-x-2 py-2 px-3 border border-green-400 rounded-md bg-white text-green-500 text-xs leading-4 font-medium uppercase tracking-wider hover:bg-green-200 focus:outline-none mr-2"><span>{{ __('Import') }}</span>
                ...
                <button wire:click="$emit('downloadTemplate')" type="button"
                    class="flex items-center space-x-2 py-2 px-3 border border-green-400 rounded-md bg-white text-green-500 text-xs leading-4 font-medium uppercase tracking-wider hover:bg-green-200 focus:outline-none"><span>{{ __('Download Template') }}</span>
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                        <path fill-rule="evenodd"
                            d="M6 2a2 2 0 00-2 2v12a2 2 0 002 2h8a2 2 0 002-2V7.414A2 2 0 0015.414 6L12 2.586A2 2 0 0010.586 2H6zm5 6a1 1 0 10-2 0v2H7a1 1 0 100 2h2v2a1 1 0 102 0v-2h2a1 1 0 100-2h-2V8z"
                            clip-rule="evenodd" />
                ...
                <input type="file" wire:model="file" id="upload-btn" hidden>
                </div>
            @endif
            </div>
            ...
            @endif
             ...
             @if($exportable)
                ...
                @if($showBtns)
                <button wire:click="$emit('{{$launchCreateEventModal}}')" type="button" class="flex items-center space-x-2 py-2 px-3 border border-green-400 rounded-md bg-white text-green-500 text-xs leading-4 font-medium uppercase tracking-wider hover:bg-green-200 focus:outline-none"><span>Create</span>
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
